...
2026年9月13日、ユーザーの指示により全3ページの検索除外を解除し、`index,follow` に変更しました。`robots.txt` は巡回を許可し、サイトマップの場所を記載しています。Google Search Consoleには公式HTTPS URLのプロパティを作成し、ホームページへ所有権確認用の公開メタタグを追加しました。所有権の確認・サイトマップ送信とURL検査の結果は、公開反映後に追記します。
